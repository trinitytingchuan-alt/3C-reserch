...
const GTMS = {};
// 各 idea 差异化 GTM：人群/切入/定价/锚点 + 落到该 idea 的差异化渠道/发布节奏/营销/指标/风险
// 说明：公司级市场事实(tamSamSom)合理共享；但落地打法(channels/launchCadence/smarketing/metrics/risks)必须按 idea 差异化，
// 否则不同需求共用一套打法，失去 GTM 意义。
const GTM_DIFF = {
  'ID-001': {
    audience: '移动办公与商旅通勤族：高频长时间佩戴眼镜，对续航与随身充电敏感',
    entry: '以X系列/Air系列续航痛点切入，主打"一天一充/热插拔备电"升级款，捆绑配件包',
    pricing: '随走量款定价(1499-1899元)，续航升级件作为加购配件(299-599元)；国补后更具性价比',
    anchor: '竞品Meta/XREAL续航普遍2-4h，雷鸟以持久续航+快充差异化',
    channels: [
      { k: '线上电商(主量)', v: '京东/天猫销量榜首，续航升级件+眼镜组合套餐618冲量' },
      { k: '配件生态', v: '官旗推"眼镜+备电"加购礼包，绑定续航卖点做复购' },
      { k: '内容种草', v: 'B站/抖音续航实测对比视频，攻"一天续航"心智，打Meta/XREAL短续航' },
    ],
    launchCadence: [
      { phase: '0-1月 静默期', todo: '雷鸟社区100人内测续航方案，收集真实充电频率与焦虑场景' },
      { phase: '2-4月 Beta', todo: '续航实测KOL内容(对比Meta/XREAL)封闭投放' },
      { phase: '5-7月 公开发布', todo: '走量款+续航件618大促，突出"续航无焦虑"卖点' },
      { phase: '8-12月 规模化', todo: '商务/通勤人群精准投放，配件复购拉动' },
    ],
    smarketing: '营销聚焦"续航焦虑"教育：SDR收集续航问询线索交销售48h跟进；内容主打实测对比与通勤场景；考核电池焦虑转化率与配件连带率。',
    metrics: [
      { k: '出货/份额', v: '全球出货29%第一(IDC)；中国32%四连冠(CINNO)' },
      { k: '续航满意度', v: '解决续航痛点后 NPS≥35、差评率下降(当前续航为差评主因E005/E012)' },
      { k: '经济性', v: '配件毛利率>主品，续航件连带率≥30%' },
      { k: '健康度', v: '月活留存≥30%，通勤场景周使用次数' },
    ],
    risks: [
      ['续航提升有限', '高', '高', '光波导+骁龙AR1功耗高，硬件难根治；需软硬结合+配件方案'],
      ['国补退坡', '中', '高', '依赖国补价格优势，退坡需靠价值锚'],
      ['竞品跟进', '中', '中', 'Meta/XREAL若推大电池/快充，需专利+体验领先'],
    ],
  },
  'ID-002': {
    audience: '短视频创作者/记录生活者：需要解放双手的AI第一视角拍摄',
    entry: 'V系列AI拍摄眼镜切入，主打"第一视角AI成片"，对标Meta Ray-Ban拍摄',
    pricing: '1799-2200元档(对标拍摄眼镜)；AI成片服务按内容订阅或内置',
    anchor: '对比Meta拍摄眼镜(国内不可用)与手机自拍，突出AI后期与隐私屏显',
    channels: [
      { k: '创作者社区', v: '与B站/抖音短视频创作者共创AI成片案例，UGC扩散' },
      { k: '线上电商', v: '拍摄款京东/天猫冲榜，主打"AI一键成片"卖点' },
      { k: '海外', v: '对标Meta Ray-Ban进Amazon/海外社媒，打"第一视角+AI"差异化' },
    ],
    launchCadence: [
      { phase: '0-1月 静默期', todo: '签约首批创作者内测，产出第一视角成片demo' },
      { phase: '2-4月 Beta', todo: '创作者共创内容，铺B站/抖音拍摄场景测评' },
      { phase: '5-7月 公开发布', todo: '拍摄款发布，打"AI成片"心智，对标Meta' },
      { phase: '8-12月 规模化', todo: '海外创作者联动，AI订阅服务上线' },
    ],
    smarketing: '营销聚焦"创作效率"：SDR收集创作者线索，销售跟进入选创作者计划；内容以UGC成片为主，考核AI成片分享率与创作者生态参与度。',
    metrics: [
      { k: '出货/份额', v: '拍摄眼镜细分份额(洛图拍摄眼镜51.7万台赛道)' },
      { k: '内容活性', v: 'AI成片月分享量、创作者生态内容数' },
      { k: '留存', v: '拍摄功能月活留存≥30%(对比E016全功能6%留存)' },
      { k: '对标', v: '第一视角拍摄稳定性/清晰度达Meta 80%水准' },
    ],
    risks: [
      ['Meta压制', '高', '高', 'Meta拍摄生态+AI碾压，需差异化AI后期与国内可用性'],
      ['拍摄质量', '中', '中', 'V3清晰度弱于Meta(E011)，需算法补强'],
      ['创作者留存', '中', '中', '创作者容易流失，需订阅+分成绑定'],
    ],
  },
  'ID-003': {
    audience: '全天候佩戴者：从尝鲜走向日常，对重量/形态敏感',
    entry: '轻量化Air/轻量款切入，主打"重量<30g、久戴无感"，攻占通勤与办公',
    pricing: '走量定价1499-1899元；轻量版本溢价200-300元',
    anchor: '对标Rokid/友商一体式偏重，突出轻量与光学自研的佩戴优势',
    channels: [
      { k: '线上电商(走量)', v: 'Air系列京东/天猫走量款，轻量化卖点主推' },
      { k: '办公/通勤场景', v: '与笔记本电脑/办公配件品牌跨界，攻白领通勤佩戴' },
      { k: '运营商', v: 'eSIM+轻量款绑合约，充话费送轻量眼镜' },
    ],
    launchCadence: [
      { phase: '0-1月 静默期', todo: '轻量款内测，采集久戴舒适度反馈' },
      { phase: '2-4月 Beta', todo: '通勤/办公场景KOL实测"久戴无感"' },
      { phase: '5-7月 公开发布', todo: '走量款发布，轻量化与佩戴舒适度主推' },
      { phase: '8-12月 规模化', todo: '运营商渠道铺开，攻白领日常佩戴' },
    ],
    smarketing: '营销聚焦"日常化佩戴"：SDR收集通勤/办公线索，销售跟进"轻量换机"；内容突出久戴无感与光学自研，考核轻量款渗透与日均佩戴时长。',
    metrics: [
      { k: '出货/份额', v: '轻量细分份额，攻占Rokid/友商占位' },
      { k: '佩戴时长', v: '日均佩戴时长≥3h，从尝鲜到日常' },
      { k: '舒适度', v: '久戴舒适度评分、退货率下降(对比E006铰链/色彩断层差评)' },
      { k: '留存', v: '月活留存≥30%' },
    ],
    risks: [
      ['形态受限', '中', '高', '轻量必然牺牲功能/续航，需在重量与能力间平衡'],
      ['差异化不足', '中', '中', '轻量化易被模仿，需光学自研+专利护城河'],
    ],
  },
  'ID-005': {
    audience: '户外/强光场景用户：观影与骑行、驾驶遮阳双重需求',
    entry: '电致变色镜片作为旗舰X系列选配切入，主打"观影+墨镜"二合一',
    pricing: '旗舰8999元(国补7649)选配变色镜片，或走量款加配499-899元',
    anchor: '对比竞品需外挂墨镜片，突出镜片智能调光一体化',
    channels: [
      { k: '旗舰+选配', v: 'X3 Pro旗舰走"技术秀肌肉"，变色镜片作旗舰专属选配' },
      { k: '户外/骑行圈层', v: '与户外装备/骑行品牌跨界，攻强光场景' },
      { k: '线上电商', v: '变色镜片加购项主推，绑定观影+遮阳场景' },
    ],
    launchCadence: [
      { phase: '0-1月 静默期', todo: '户外场景内测变色镜片，采集强光/观影体验' },
      { phase: '2-4月 Beta', todo: '户外KOL实测"观影+墨镜二合一"' },
      { phase: '5-7月 公开发布', todo: '旗舰发布，变色镜片作为差异化卖点' },
      { phase: '8-12月 规模化', todo: '选配件放量，攻户外/驾驶人群' },
    ],
    smarketing: '营销聚焦"一镜多用"：SDR收集户外/强光场景线索；内容突出观影+遮阳一体化，考核选配连带率与户外场景转化。',
    metrics: [
      { k: '选配率', v: '变色镜片选配率≥15%、连带收入' },
      { k: '份额', v: '旗舰细分带动整体份额' },
      { k: '满意度', v: '户外场景NPS、强光清晰度评分' },
    ],
    risks: [
      ['成本高', '高', '高', '电致变色+光学自研成本高，毛利压力'],
      ['场景小众', '中', '中', '户外/强光细分人群有限，需放大观影主场景'],
    ],
  },
  'ID-006': {
    audience: '尝鲜用户与开发者：需要内容与应用生态解锁眼镜价值',
    entry: 'X3 Pro等旗舰打造生态样板，接入AI大模型+运营商云服务',
    pricing: '旗舰定价不追求走量，生态服务/应用订阅为后续变现',
    anchor: '对标Meta生态碾压与安卓虚拟机短板，自建原生应用+运营商5G+AR+AI闭环',
    channels: [
      { k: '旗舰生态样板', v: 'X3 Pro树立原生应用+大模型生态标杆' },
      { k: '开发者', v: '开放SDK/开发者计划，吸引原生应用开发' },
      { k: '运营商云', v: '移动/联通5G+AR+AI云服务，绑定生态能力' },
    ],
    launchCadence: [
      { phase: '0-1月 静默期', todo: '旗舰生态内测，验证原生应用与大模型' },
      { phase: '2-4月 Beta', todo: '开发者计划启动，首批原生应用上架' },
      { phase: '5-7月 公开发布', todo: '旗舰发布+生态发布，接入运营商云' },
      { phase: '8-12月 规模化', todo: '开发者生态扩张，应用订阅变现' },
    ],
    smarketing: '营销聚焦"生态价值"：SDR收集开发者与尝鲜用户线索；内容以生态应用Demo为主，考核应用上架数与生态使用率(目标破6%留存E016)。',
    metrics: [
      { k: '生态', v: '原生应用数量、开发者计划参与数' },
      { k: '留存', v: '生态功能月活留存突破6%(E016现状)' },
      { k: '变现', v: '应用订阅/云服务收入、ARPU' },
    ],
    risks: [
      ['生态难建', '高', '高', '内容与应用生态是Meta强项，雷鸟需差异化切入'],
      ['安卓虚拟机', '中', '中', '虚拟机搬应用适配差，需原生投入'],
      ['留存低', '高', '中', '新功能使用率仅6%(E016)，需解决有功能无粘性'],
    ],
  },
};
for (const s of scores) {
  ...
  GTMS[s.ideaId] = {
    ...
    channels: diff.channels || GTM_BASE.channels,
    launchCadence: diff.launchCadence || GTM_BASE.launchCadence,
    smarketing: diff.smarketing || GTM_BASE.smarketing,
    metrics: diff.metrics || GTM_BASE.metrics,
    risks: diff.risks || GTM_BASE.risks,
  };
}
